...
public class VentasNotaPedido extends javax.swing.JFrame {
    ...
    public VentasNotaPedido(String usuario) throws Exception {
        setUndecorated(true);
        initComponents();
...
//        panelVuelto.getRootPane().setBackground(Color.DARK_GRAY);
        ...
        //new NpBarrasControl().llenarListaCategorias(listaCategorias);
        txtCaja.setText(new NpBarrasControl().getCajaDeUsuario(usuario));
        ...
        bloquearBotones();
        int idFlujoCaja = new FlujoCajaDAO().getIdFlujo(new NpBarrasControl().getIdUsuarioConNombre(txtUsuario.getText()), new NpBarrasControl().getIdCaja(txtCaja.getText()));
        System.out.println("idusuario: " + new NpBarrasControl().getIdUsuarioConNombre(txtUsuario.getText()));
        System.out.println("idcaja: " + new NpBarrasControl().getIdCaja(txtCaja.getText()));
        System.out.println("flujo n°: " + idFlujoCaja);
    ...
    private void initComponents() {
        ...
        jLabel21.setText("VENTAS BARRA NP");
        jPanel8.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 20, -1, 30));

        jLabel23.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/receipt.png"))); // NOI18N
        jPanel8.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, -1, 70));

        txtFecha.setEditable(false);
        txtFecha.setBackground(new java.awt.Color(255, 102, 102));
        ...
        txtHora.setBackground(new java.awt.Color(255, 102, 102));
        ...
        jPanel8.add(txtCaja, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 20, 250, -1));
        ...
        getContentPane().add(cboxMasVendidos, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 670, -1, 40));
...
//                listaCategorias.clearSelection();
    ...
    private void btnPendientesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPendientesActionPerformed
        //new NpBarrasPendientes().setVisible(true);
        ...
        try {
            ...
            if (!txtMontoRecibido.getText().trim().isEmpty()) {//si NO esta vacio
                ...
                if (Double.parseDouble(txtVuelto.getText()) >= 0) {//si el monto es MAYOR a cero
                    ...
                    v.setIdUsuario(new NpBarrasControl().getIdUsuarioConNombre(usuario));
                    v.setIdCliente(1);
                    v.setIdTipoComprobante(1);
                    v.setEstado(1);//ESTADO->> 0:PENDIENTE     1:PAGADO
                    v.setTipoPago(tipoPago);
                    v.setnOperacion("");
                    v.setIdCaja(new NpBarrasControl().getIdCaja(txtCaja.getText()));
                    v.setIdFlujoCaja(new FlujoCajaDAO().getIdFlujo(new NpBarrasControl().getIdUsuarioConNombre(usuario), new NpBarrasControl().getIdCaja(txtCaja.getText())));

                    NpBarrasControl vc = new NpBarrasControl();
...
//                    String serie = null;
                            ...
                            if (flag > 0) {
                                ...
                                parametros.put("idnpbarra", idventa);
                                ...
                                mrv = new MyiReportVisor(System.getProperty("user.dir") + "\\reportes\\NotaPedido.jrxml", parametros, getPageSize());
                                mrv.setNombreArchivo("NotaPedido");
                                try {
                                ...
                                mrv.dispose();
                                new NpBarrasControl().restarStock(tblPedidos, 1);
                                panelVuelto.dispose();
                                txtVuelto.setText("");
                                txtMontoRecibido.setText("");
                                lblPago.setText("");
...
//                    String serie = null;
                            ...
                            if (flag > 0) {
                                ...
                                parametros.put("vuelto", Double.parseDouble(txtVuelto.getText()));
                                parametros.put("nroSerie", nroSerie);
                                mrv = new MyiReportVisor(System.getProperty("user.dir") + "\\reportes\\NotaPedido2.jrxml", parametros, getPageSize());
                                mrv.setNombreArchivo("NotaPedido2");
                                try {
                                    mrv.exportarAPdfConCopia();
                                } catch (Exception ex) {
                                    System.out.println(ex.getMessage());
                                ...
                                mrv.dispose();
                                new NpBarrasControl().restarStock(tblPedidos, 2);
                                panelVuelto.dispose();
                                txtVuelto.setText("");
                                txtMontoRecibido.setText("");
                                lblPago.setText("");
...
//                    String serie = null;
                            ...
                            if (flag > 0) {
                                ...
                                parametros.put("vuelto", Double.parseDouble(txtVuelto.getText()));
                                parametros.put("nroSerie", nroSerie);
                                mrv = new MyiReportVisor(System.getProperty("user.dir") + "\\reportes\\NotaPedido3.jrxml", parametros, getPageSize());
                                mrv.setNombreArchivo("NotaPedidoVip");
                                try {
                                    mrv.exportarAPdfConCopia();
                                } catch (Exception ex) {
                                    System.out.println(ex.getMessage());
                                ...
                                mrv.dispose();
                                new NpBarrasControl().restarStock(tblPedidos, 3);
                                panelVuelto.dispose();
                                txtVuelto.setText("");
                                txtMontoRecibido.setText("");
                                lblPago.setText("");
...
//                        }
    ...
    private void btnCobrarConTarjetaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCobrarConTarjetaActionPerformed
        try {
            if (!txtNumReferencia.getText().trim().isEmpty()) {
                ...
                v.setFecha(fecha);
                v.setHora(new ManejadorFechas().getHoraActual());
                v.setIdUsuario(new NpBarrasControl().getIdUsuarioConNombre(usuario));//registra el id de usuario que hace la venta
                ...
                v.setIdCaja(new NpBarrasControl().getIdCaja(txtCaja.getText()));//caja que realiza la operacion
                v.setIdFlujoCaja(new FlujoCajaDAO().getIdFlujo(new NpBarrasControl().getIdUsuarioConNombre(usuario), new NpBarrasControl().getIdCaja(txtCaja.getText())));//flujo de caja que realiza la operacion
                NpBarrasControl vc = new NpBarrasControl();
                ...
                System.out.println("ultima nota de pedido: " + idventa);
                System.out.println("flag: " + flag);
                ...
                if (flag > 0) {
                    ...
                    switch (tipoPago) {
                        ...
                        case 2:
                            ...
                            parametros.put("total", total);
                            parametros.put("nroSerie", nroSerie);
                            mrv = new MyiReportVisor(System.getProperty("user.dir") + "\\reportes\\NotaPedidoTarjetaMaster" + numTicket + ".jrxml", parametros, getPageSize());
                            mrv.setNombreArchivo("NotaPedidoTarjetaMaster" + numTicket + "");
                            try {
                                mrv.exportarAPdfConCopia();
                            } catch (Exception ex) {
                                System.out.println(ex.getMessage());
                        ...
                        case 3:
                            ...
                            parametros.put("total", total);
                            parametros.put("nroSerie", nroSerie);
                            mrv = new MyiReportVisor(System.getProperty("user.dir") + "\\reportes\\NotaPedidoTarjetaVisa" + numTicket + ".jrxml", parametros, getPageSize());
                            mrv.setNombreArchivo("NotaPedidoTarjetaVisa" + numTicket + "");
                            try {
                                mrv.exportarAPdfConCopia();
                            } catch (Exception ex) {
                                System.out.println(ex.getMessage());
    ...
    private void btnBebidasJarraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBebidasJarraActionPerformed
        try {
            ...
            NpBarrasControl vc = new NpBarrasControl();
            vc.llenarTablaProductos(categoria, tblProductos, caja);
    ...
    private void txtCobrarCombinadaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtCobrarCombinadaActionPerformed
        ...
        try {
            ...
            if (fila >= 0) {
                //PRIMERO CREAR LA NOTA DE PEDIDO
                NpBarra v = new NpBarra();
                v.setFecha(fecha);
                v.setHora(new ManejadorFechas().getHoraActual());
                v.setIdUsuario(new NpBarrasControl().getIdUsuarioConNombre(usuario));
                v.setIdCliente(1);
                v.setIdTipoComprobante(3);//BOLETA,TICKET - FACTURA - NOTA DE PEDIDO
                ...
                //SEGUNDO CAPTURAMOS DATOS PARA REGISTRAR DETALLE DE NOTA DE PEDIDO
                String caja = txtCaja.getText();
                ...
                switch (caja) {
                    case "GENERAL 1":
                        ...
                        if (nprod.registrar(v)) {//REGISTRA LA NOTA DE PEDIDO
                            ...
                            System.out.println("SERIE: " + nroSerie);
                            System.out.println("ultima nota registrada: " + idUltimaNotaPedido);

                            Operacion_npDAO npDAO = new Operacion_npDAO();
                            for (int i = 0; i < tblOp.getRowCount(); i++) {
                                Operacion_np op = new Operacion_np();
                                op.setIdnpbarra(idUltimaNotaPedido);
                            ...
                            if (flag > 0) {
                                ...
                                parametros.put("idnpbarra", idUltimaNotaPedido);
                                parametros.put("total", total);
                                parametros.put("nom_cajero", usuario);
                                parametros.put("nroSerie", nroSerie);
                                mrv = new MyiReportVisor(System.getProperty("user.dir") + "\\reportes\\NotaPedido_op.jrxml", parametros, getPageSize());
                                mrv.setNombreArchivo("NotaPedido_op");
                                try {
                                    mrv.exportarAPdfConCopia();
                                } catch (Exception ex) {
                                    System.out.println(ex.getMessage());
                                ...
                                JOptionPane.showMessageDialog(null, "ERROR EN REGISTRO DE LA NOTA DE PEDIDO");
                            }
                        }
                        break;
                    case "GENERAL 2":
                        NpBarra2DAO nprod2 = new NpBarra2DAO();
                        if (nprod2.registrar(v)) {//REGISTRA LA NOTA DE PEDIDO
                            ...
                            if (flag > 0) {
                                ...
                                parametros.put("nom_cajero", usuario);
                                parametros.put("nroSerie", nroSerie);
                                mrv = new MyiReportVisor(System.getProperty("user.dir") + "\\reportes\\NotaPedido_op2.jrxml", parametros, getPageSize());
                                mrv.setNombreArchivo("NotaPedido_op2");
                                try {
                                    mrv.exportarAPdfConCopia();
                                } catch (Exception ex) {
                                    System.out.println(ex.getMessage());
                        ...
                        break;
                    case "VIP":
                        NpBarra3DAO nprod3 = new NpBarra3DAO();
                        if (nprod3.registrar(v)) {//REGISTRA LA NOTA DE PEDIDO
                            ...
                            if (flag > 0) {
                                ...
                                parametros.put("nom_cajero", usuario);
                                parametros.put("nroSerie", nroSerie);
                                mrv = new MyiReportVisor(System.getProperty("user.dir") + "\\reportes\\NotaPedido_op3.jrxml", parametros, getPageSize());
                                mrv.setNombreArchivo("NotaPedido_op3");
                                try {
                                    mrv.exportarAPdfConCopia();
                                } catch (Exception ex) {
                                    System.out.println(ex.getMessage());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentasNotaPedido.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new VentasNotaPedido().setVisible(true);
                } catch (Exception ex) {
                    System.out.println(ex.getMessage());
                }
            }
    ...
    //metodo para cargar los productos mas vendidos caja
    public void tablaProductosMasVendidos(int idFlujoCaja) throws Exception {
        ...
        try {
            ...
            PreparedStatement pst = cc.prepareStatement("select producto.nombre, presentacion.descripcion, productopresentacion.stock2, productopresentacion.precio, sum(npbarra_prod.cantidad) \n"
                    + "from npbarra\n"
                    ...
                    + "where npbarra.idflujocaja = " + idFlujoCaja + " and productopresentacion.idalmacen=2 \n"
                    + "group by producto.nombre\n"
                    + "order by sum(npbarra_prod.cantidad) desc");
    ...
    //metodo para cargar los productos mas vendidos de ventas 2 caja 2
    public void tablaProductosMasVendidos2(int idFlujoCaja) throws Exception {
        ...
        try {
            con.conectar();
            Connection cc = con.getConexion();
            PreparedStatement pst = cc.prepareStatement("select producto.nombre, presentacion.descripcion, productopresentacion.stock2, productopresentacion.precio, sum(npbarra_prod2.cantidad)\n"
                    + "from npbarra2\n"
                    ...
                    + "inner join producto on productopresentacion.idproducto = producto.idProducto\n"
                    + "inner join presentacion on productopresentacion.idpresentacion = presentacion.idPresentacion\n"
                    + "where npbarra2.idflujocaja = " + idFlujoCaja + " and productopresentacion.idalmacen=2 \n"
                    + "group by producto.nombre\n"
                    + "order by sum(npbarra_prod2.cantidad) desc");
            ResultSet rs = pst.executeQuery();
            while (rs.next()) {
                lista[0] = rs.getString(1);
                lista[1] = rs.getString(2);
    ...
    public void tablaProductosMasVendidos3(int idFlujoCaja) throws Exception {
        ...
        try {
            con.conectar();
            Connection cc = con.getConexion();
            PreparedStatement pst = cc.prepareStatement("select producto.nombre, presentacion.descripcion, productopresentacion.stock2, productopresentacion.precio, sum(npbarra_prod3.cantidad)\n"
                    + "from npbarra3\n"
                    ...
                    + "inner join producto on productopresentacion.idproducto = producto.idProducto\n"
                    + "inner join presentacion on productopresentacion.idpresentacion = presentacion.idPresentacion\n"
                    + "where npbarra3.idflujocaja = "+idFlujoCaja+" and productopresentacion.idalmacen=3\n"
                    + "group by producto.nombre\n"
                    + "order by sum(npbarra_prod3.cantidad) desc");
            ResultSet rs = pst.executeQuery();
            while (rs.next()) {
                lista[0] = rs.getString(1);
                lista[1] = rs.getString(2);
    ...
    //METODO PARA LOS TAMAÑOS DE LA IMPRESION FACTURA
    ...
    /*obtener el id de productopresentacion para restar el stock*/
