...
public class VentasVIP extends javax.swing.JFrame {
    ...
    public VentasVIP(String usuario) throws Exception {
        setUndecorated(true);
        initComponents();
...
//        panelVuelto.getRootPane().setBackground(Color.DARK_GRAY);
    ...
    private void initComponents() {
        ...
        btbAguaMineral = new javax.swing.JToggleButton();
        ...
        operacionCombinada.getContentPane().add(btnCeroCombinada, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 530, 110, 90));
        ...
        btbAguaMineral.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/san-mateo.png"))); // NOI18N
        btbAguaMineral.setContentAreaFilled(false);
        btbAguaMineral.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btbAguaMineralActionPerformed(evt);
            }
        });
        PanelComplementos.getContentPane().add(btbAguaMineral, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 550, 150, 250));
        ...
        getContentPane().add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1530, 180, 310, 10));
        ...
        btnBebidasJarra.setBackground(new java.awt.Color(0, 0, 0));
        ...
        btnCocteles.setBackground(new java.awt.Color(51, 51, 51));
        ...
        btnBebidasPorBotella.setBackground(new java.awt.Color(102, 102, 102));
        ...
        btnGaseosasCervezas.setBackground(new java.awt.Color(102, 102, 102));
        ...
        btnCigarrillos.setBackground(new java.awt.Color(51, 51, 51));
...
//                    String serie = null;
    ...
    private void btnBebidasJarraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBebidasJarraActionPerformed
        try {
            ...
            VentasControl vc = new VentasControl();
            vc.llenarTablaProductos(categoria, tblProductos, 3);
...
//                    String serie = null;
    ...
    private void btbAguaMineralActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btbAguaMineralActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentasVIP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JToggleButton btbAguaMineral;
